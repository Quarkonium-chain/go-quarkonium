...
echo Setup GPG
"${HOME}"/go/src/github.com/Quarkonium-chain/go-quarkonium/scripts/release/test/util/gpg-fake.sh

"${HOME}"/go/src/github.com/Quarkonium-chain/go-quarkonium/scripts/release/test/deb/run_ubuntu.sh
date "+build_release done testing ubuntu %Y%m%d_%H%M%S"

"${HOME}"/go/src/github.com/Quarkonium-chain/go-quarkonium/scripts/release/test/rpm/run_centos.sh
date "+build_release done testing centos %Y%m%d_%H%M%S"

echo Use Docker to perform a smoke test.
pushd "${HOME}"/go/src/github.com/Quarkonium-chain/go-quarkonium/scripts/release/test/util
